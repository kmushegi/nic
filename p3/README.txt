...
p3
	...
	* auto-test.py
		...
		- relies on joblib framework for multiprocessing
	* process-data.py
		- process data generated by auto-test.py
	* notify.py
		- notify on auto-test progress by checking # of files in stats/ folder 
		  and sending a text message with the information. 
		- Relies on Twilio API
